...
## What Makes a Good Project AGENTS.md
...
Your AGENTS.md should grow organically based on actual problems, not anticipated ones.

## Override Files

Codex supports `AGENTS.override.md` for local overrides that shouldn't be committed:
- Personal preferences for a specific project
- Local environment quirks
- Experimental rules you're testing

The override file is merged with the main AGENTS.md at runtime.
